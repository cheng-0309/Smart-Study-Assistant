    ...
    <div data-testid="note-display">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              variant="outline"
              className="rounded-sm h-9 gap-2 border-border"
            >
      ...
      <div className="bento-grid">
        ...
        <motion.div
          ...
          animate="visible"
          variants={fadeIn}
          className="bento-hero border border-border bg-card p-6"
        ...
        <motion.div
          ...
          animate="visible"
          variants={fadeIn}
          className="bento-square border border-border bg-card p-6"
          data-testid="formulas-section"
        >
            ...
            <div className="space-y-3">
              {content.formulas.map((f, i) => (
                <div key={i} className="border border-border p-3 bg-background">
                  <code className="text-sm font-bold font-mono text-[hsl(var(--primary))] block mb-1">
                    {f.formula}
                  </code>
        ...
        <motion.div
          ...
          animate="visible"
          variants={fadeIn}
          className="bento-wide border border-border bg-card p-6"
        ...
        <motion.div
          ...
          variants={fadeIn}
          className="bento-square border border-border bg-card p-6"
          data-testid="quick-revision-section"
        >
          <SectionLabel icon={ListChecks} label="Quick Revision" />
          <ol className="space-y-2">
            {content.quick_revision.map((point, i) => (
              <li key={i} className="flex items-start gap-3 text-sm leading-relaxed">
                <span
                  className="font-mono text-xs font-bold text-[hsl(var(--primary))] mt-0.5 shrink-0"
